			...
			<div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
				...
				<div className="p-6.5 scroll-smooth">
					<label className="mb-2.5 block text-black dark:text-white">
						¿Seguro que quieres eliminar este tipo de motor?
					</label>
					<div className="flex justify-end border-t border-stroke p-6.5 dark:border-strokedark">
						<button onClick={() => handleDeleteEngineType()} type="button" className="rounded bg-danger py-2.5 px-6 text-base font-medium text-white shadow-button transition hover:opacity-80">
							Eliminar
						</button>
...
export default DeleteEngineTypeModal;
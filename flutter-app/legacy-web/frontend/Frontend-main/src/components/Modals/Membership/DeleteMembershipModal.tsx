    ...
    const handleDeleteMembership = async () => {
        try {
          // Making the API call to delete by its ID
            const result = await deleteFetch(`memberships/${deleteMembershipId}`);
    ...
    return (
        ...
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="flex justify-center border-t border-stroke p-6.5 dark:border-strokedark">
            <button onClick={() => handleDeleteMembership ()} type="button" className="rounded bg-danger py-2.5 px-6 text-base font-medium text-white shadow-button transition hover:opacity-80">
              Eliminar
            </button>
